        ...
        <div style={{ overflow: "hidden" }}>
          ...
          >
            ...
            <p className="text-xl text-neutral-900 leading-relaxed max-w-xl mt-3">
              I focus on a problem most platforms face: how do you get people to contribute, and keep contributing? I design the systems that make that happen at scale.
            </p>
            <Link href="/about" className="inline-flex items-center gap-1.5 text-sm text-neutral-500 hover:text-neutral-900 mt-4 transition-colors duration-200">
              Read more about me
              ...
              <div className="flex flex-wrap items-start gap-8 mb-8">
                <div className="flex-1 min-w-[160px]">
                  <h2 className="text-3xl tracking-tight mb-3 leading-tight">
                    <span className="title-highlight px-1.5">{featured.title}</span>
                  </h2>
